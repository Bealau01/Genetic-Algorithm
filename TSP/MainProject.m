...
np=80; %number of individuals in the population
...
npi=40; %number of individuals selected (all different)
k=12;   %select the best in each random group of k individuals
...
pm=0.15; %probability that a mutation occurs in each individual
